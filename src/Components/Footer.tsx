...
//       <Link 
//       target='blank' href={"https://www.facebook.com/soobia.ali.3?mibextid=ZbWKwL"} className="text-gray-900">
//       <FaFacebook className='text-3xl ' />
//       </Link>

//       <Link
//       target='blank' href={"https://vercel.com/soobia-raos-projects"} className="ml-3 text-gray-900">
//       <IoLogoVercel className='text-3xl' />
//       </Link>
      
//       <Link
//       target='blank' href={" https://linkedin.com/comm/mynetwork/discovery-see-all?usecase=PEOPLE_FOLLOWS&followMember=sobia-rao-31567a300"} className="ml-3 text-gray-900">
  ...
  return (
    <div>
        ...
        <div className="container px-5 py-24 mx-auto mt-[40px]">
          ...
          {/* Flex container to align the footer columns */}
          <div className="flex flex-wrap md:text-left text-center order-first">

            {/* First Column: Hekto (Company Info) */}
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                <h2 className="title-font font-bold text-black tracking-widest text-lg mb-3">
                Hekto
                </h2>

                {/* Input field for email sign-up */}
                <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                  <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                    <label
                      htmlFor="footer-field"
