...
const Trending = () => {
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto mb- px-4 sm:px-2 lg:px-8">
        {/* Section Title */}
        <h2 className="text-3xl md:text-2xl gap-8 font-bold text-[#151875] text-center mb-16">
          Trending Products
        </h2>
    ...
    View Collection
        ...
        <div className=" flex flex-col justify-between relative h-[200px]">
          ...
          <Image
            ...
            width={200}
            height={200} 
             className="absolute bottom-1  right-[140px] object-contain"
