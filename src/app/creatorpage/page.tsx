    ...
    <div className="px-6 lg:px-20 py-10 font-sans text-[#151875]">
      ...
      <section className="my-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: "/image/picicon1.png", title: "Free Delivery" },
            { icon: "/image/picion2.png", title: "100% Cash Back" },
            { icon: "/image/picicon3.png", title: "Quality Product" },
            { icon: "/image/picicon4.png", title: "24/7 Support" },
          ].map((feature, index) => (
            <div
              key={index}
      ...
      <section className="my-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { name: "Selina Gomez", image: "/image/client1.png" },
            { name: "John Doe", image: "/image/client2.png" },
            { name: "Emma Watson", image: "/image/client3.png" },
          ].map((client, index) => (
